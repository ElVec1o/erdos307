...
**Version 1.68.0 · 2 September 2026** · Erdős #307 is **open**; this repository holds the paper, its Lean formalization, and every program behind its numbers.
...
paper/   erdos307-core.pdf       — the paper (32 pp; the results)
         erdos307-companion.pdf  — the companion (105 pp; explorations, closures, the square sieve and the density theorem)
