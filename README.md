...
```
paper/   erdos307.tex, erdos307.pdf   — the note (92 pp; self-contained bibliography)
...
- **Lean:** `cd lean && lake exe cache get && lake build` (Lean / mathlib `v4.30.0`). Then
  `lake env lean Check.lean` prints the axiom dependencies of 322 declarations across all 38 modules
