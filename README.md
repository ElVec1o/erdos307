...
```
paper/   erdos307.tex, erdos307.pdf   — the note (95 pp; self-contained bibliography)
...
- **Lean:** `cd lean && lake exe cache get && lake build` (Lean / mathlib `v4.30.0`). Then
  `lake env lean Check.lean` prints the axiom dependencies of 342 declarations across all 42 modules
