...
\end{corollary}
\begin{proof}
Repeats Proposition~\ref{K-prop:close59}'s bound on the minimal side with the minimum of $R/T$ now over $|U|\ge61$,
...
are coprime and squarefree (Theorem~\ref{K-thm:structure}). By Proposition~\ref{prop:sectors}\textup{(ii)},
...
\emph{Why the analytic method is starved: $N(r)\le1$.} The rank--one rigidity (Section~\ref{K-sec:status} of the core note) has a sharp consequence for the circle--method
