...
Corollary~\ref{C-cor:a9rate} remains conjectural, blocked by one thing only --- the pretentious
...
Remark~\ref{C-rem:a9ceiling} and at the corollary. Nothing else in this paper
