...
certificate, requiring no factorisation, then proves $46{,}049$ of the $49{,}961$ one--new--prime
families at level $60$ empty, the canonical one (the first $59$ primes plus any $q$) among them. We add a parity dichotomy (a hypothetical all--odd
...
primality testing at all) closes a further $14{,}830$: in total $46{,}049$ of the $49{,}961$
one--new--prime families at level $60$ are proven empty ($92.2\%$), the $3{,}912$ still open
having $A_S,B_S$ that resist factorisation with every found piece of symbol $+1$. (Both $A$ and
$B$ of the canonical family are Baillie--PSW probable primes; the proof does not use this.)
\end{proof}
...
further $14{,}830$: in total $46{,}049$ of the $49{,}961$ single--tail families at level $60$ are
proven empty ($92.2\%$), $3{,}912$ remaining open. The weapon is intrinsically \emph{arity--one}:
on the pair sector, with $s=p+q$, $t=pq$, the plus square reads $x^2=A_Wt+D_Ws$, so at
$\ell\mid A_W$ the condition $x^2\equiv D_Ws\pmod\ell$ depends on $s$ and only thins its classes;
a pair--sector member instead requires the \emph{three} simultaneous squares $x^2=A_Wt+D_Ws$,
$y^2=B_Wt+D_Ws$, $s^2-4t=\square$ --- a two--parameter surface per base $W$, beyond reciprocity
and, at present, beyond us.
\end{remark}
...
Open problems: (i) close the residual $3{,}912$ single--tail families at level $60$ and find an
