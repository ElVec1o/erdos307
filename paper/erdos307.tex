...
Open problems: (i) decide whether any level beyond $60$ can be closed, e.g.\ by resolving the
Pell--type tail family of Remark~\ref{rem:tier60} (the finite verification of
Proposition~\ref{prop:close59} itself is now Lean--checked, \texttt{erdos307\_sixty}); (ii) decide
