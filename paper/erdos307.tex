...
Proposition~18 claims the unconditional $r+s\ge34$, with $r+s\ge57$ if $\min\{p_1,q_1\}\ge3$ and
$r+s\ge110$ if $\min\{p_1,q_1\}\ge5$, together with $p_1<r$, $q_1<s$ and
$\max\{m,n\}\ge\prod_{i=1}^{17}p_i\approx1.92\times10^{21}$. Its proof does not establish them.
...
than an improvement on an earlier one. None of this diminishes \cite{Kovic2012}, which remains the standard reference and whose
Propositions~16 and~17 we use.
