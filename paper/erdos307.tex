...
\date{Version 1.53.0\quad 2 September 2026}
...
over primes at most $59$ with $\omega(d)\le10$ (both now cleared, the smaller family being a subset
of the larger), and the full range carries the same $2^{58}$ split ambiguity as the tail families
themselves. Finiteness here converts the sector programme into a
