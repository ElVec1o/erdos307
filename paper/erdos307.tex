...
each of the $18.2$ million bases. Whether it kills them is not settled here; the point is that the
pair sector is a finite target of measured size against which the existing weapon is admissible.
\end{remark}
