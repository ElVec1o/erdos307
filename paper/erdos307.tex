...
to be the primes $7\le p\le271$ and nine rungs gives $|P|=64$, $|Q|=3$, largest prime of $505$
digits, and, in exact rational arithmetic,
\[ \bigl|\sigma(P)\sigma(Q)-1\bigr|\;=\;9.5748\ldots\times10^{-1007}. \]
Every rung prime is \emph{proved} prime by \textup{APR--CL}, the $505$--digit one in about six
seconds, and the whole verification runs in under ten
\textup{(\texttt{code/nearmiss\_effective.gp})}.
\end{proposition}
...
largest prime already give $6.07\times10^{-66}$. The witness above approaches $1$ from below; taking
