...
\date{Version 1.62.0\quad 2 September 2026}
...
the least odd plus--hit with $\omega$ odd, and there is no other below $10^8$
\textup{(\texttt{code/plushit\_omega.rs})}. So the parity is a bias of about $99.9\%$ and not a law,
...
$t=\#\{p\mid v:p\equiv3\bmod4\}$, every one of the $1{,}252$ has $t\equiv0$ or $1\pmod4$, as the
identity $\prod_{p\mid v}\bigl(\tfrac{v/p}p\bigr)=(-1)^{\binom t2}$ requires, the counterexample
included with $t=4$. The observed pairs $(\omega,t)$ are $(2,0)$, $(4,1)$, $(6,4)$ and $(7,4)$.
