...
proven empty ($93.0\%$), $3{,}478$ remaining open (each a balanced ${\sim}57$--digit semiprime, factoring--hard).
...
exactly)}. The pair sector is therefore not a barrier of a different kind from the one--new--prime
...
buys. Among all sectors $d$ that are squarefree with $\omega(d)\le10$ and every prime factor at most
$59$, exactly $1{,}533$ have mass floor $|P\cup Q|=60$; in every one of them the floor value of
...
and any support of size $60$ must have $\omega(d)\ge11$ or a sector prime exceeding $59$. This does
...
over primes at most $59$ with $\omega(d)\le10$ (both cleared, the smaller family being a subset of the
larger), and it does not saturate. Holding $\omega(d)\le8$ and letting the prime bound $B$ grow, the
...
\begin{conjecture}[Odd plus--hits have an even number of prime factors]\label{conj:plusomega}
Every odd squarefree $v$ with $\omega(v)\ge2$ and $v'+2v$ a perfect square has $\omega(v)$ even.
\end{conjecture}

The evidence is $598$ odd plus--hits to $2\times10^7$, all with $\omega$ even, and the parity of
$\omega$ is not otherwise constrained here, so the statement carries real weight rather than the
vacuous confirmation an event of negligible probability would give. The joint shape is narrower still:
writing $t=\#\{p\mid v:p\equiv3\bmod4\}$, the pairs $(\omega,t)$ observed are $(2,0)$ with $522$
instances, $(4,1)$ with $75$, and $(6,4)$ with one. The known congruences do not force it. Since
$\gcd(v,v')=1$ one has $\gcd(v,r)=1$ for $r^2=v'+2v$, and $r\equiv\omega(v)\bmod2$; if $r$ is even then
$\sum_{p\mid v}p\equiv2\pmod4$, which is what the three observed shapes satisfy, but $r$ odd requires
only $\sum_{p\mid v}p\equiv v-2\pmod8$, and that is satisfiable, for instance at $v=105$. So the
obstruction, if there is one, is not congruential at these moduli.
