...
It is not enough to ask only that each polynomial take prime values for infinitely many integers $t$, without requiring the values to be positive on a common branch. As printed that statement is
