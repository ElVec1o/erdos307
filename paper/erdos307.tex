...
$N\equiv D/p\pmod p$: the cofactor structure of rigidity recurs inside its own certificate.
Empirically, over the $49{,}961$ bases, each factor is a fair coin ($49.9\%$, $50.0\%$), yet the
kill rate is $31{,}219/49{,}961=0.62487$ --- within $0.06\sigma$ of exactly $5/8$. The mechanism
sits in the conditional law: $(D_1\mid N)$ is fair for $N\equiv1,5\pmod 8$ but lands $-1$ for
$\approx3/4$ of bases with $N\equiv3$ and $+1$ for $\approx3/4$ with $N\equiv7$, whence
$\bigl(\tfrac34+\tfrac12+\tfrac12+\tfrac34\bigr)/4=5/8$. We have no explanation for the
conditional $3/4$; the bias is aggregate and yields no second certificate.
\end{remark}
