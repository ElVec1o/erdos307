...
Over all $76{,}342{,}726$ such $n\le2\times10^8$, $(\ast)$ holds for every
$\lambda\in(0.269470,\,1.273733)$ and fails for no step
\textup{(\texttt{code/lyap\_battery.rs})}. The interval narrows with the range, of width
$1.654,\,1.267,\,1.237,\,1.116,\,1.092,\,1.004$ at cutoffs $10^4$ through $2\times10^8$. Six
