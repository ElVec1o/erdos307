...
We nonetheless do not have a proof of $\rho<1$, and record the shape of a possible failure: it would
need $n$ even with $\sigma(n)$ close to $1$ and $n'$ carrying many small odd primes, so that
$\sigma(n')$ approaches $\sigma(n)$. Ruling that out is again a statement about the factorisation of
a determined value, which is the obstruction met throughout this paper.
