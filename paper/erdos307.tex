...
balanced semiprime. None of this is needed: in the pair sector the tail is bounded by $1/(2-T(R))$, and
Proposition~\ref{prop:pairclosed} decides every base by testing its tails individually.
\end{remark}
...
level $60$ is now zero there, and the pair sector is empty by Proposition~\ref{prop:pairclosed}. This does not touch
the reliability of the count (which ignores the $N(r)\le1$ rigidity), but it retires the level--$60$
