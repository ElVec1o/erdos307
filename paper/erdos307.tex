...
\begin{remark}[Why the exponent is $-1/2$ and not $-1/4$]\label{rem:a9rateimproved}
A rate of $\ll N\log\log N(\log N)^{-1/4}$, balancing at $P\asymp(\log N)^{1/4}$. Carrying the balance properly against the Hal\'asz floor gives
