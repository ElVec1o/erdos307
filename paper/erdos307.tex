...
locates the whole difficulty. Quantitatively the wall is \emph{double}--exponential in expectation:
...
$b=a'$ is the chain equation $a''+a'=a$, whose solutions up to $10^7$ are
$\{6,\,42,\,15590,\,47058\}$: every primary pseudoperfect number whose predecessor is prime solves
it ($1806$ fails, $1805$ not being squarefree), while $15590=2\cdot5\cdot1559$ is sporadic. All
census claims verified exhaustively (\texttt{code/deviation\_halfplane.py}).
\end{proposition}
\begin{proof}
...
uniformly in $k$ --- the minus--side analogue of the plus side's Titchmarsh question. By
