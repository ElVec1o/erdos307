...
Over all $7{,}480{,}605$ such $n\le2\times10^7$, $(\ast)$ holds for every
$\lambda\in(0.262757,\,1.354303)$ and fails for no step
\textup{(\texttt{code/invent\_lyapunov.rs})}. The interval narrows with the range,
$1.654,\,1.267,\,1.237,\,1.116,\,1.092$ at cutoffs $10^4$ to $2\times10^7$. Six candidate functions
were tested and five died, among them the control $\delta=\log n$, which fails first at $n=30$ where
$\sigma=1.0333$; a battery that did not kill it would not be testing anything.
...
those $n$ contribute \emph{lower} demands rather than upper ones. The binding upper constraint at
$2\times10^7$ comes instead from $\sigma(n)=0.2947$, far from $1$. The two demands are supported on
