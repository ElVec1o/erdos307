...
\date{Version 1.56.0\quad 2 September 2026}
...
$|P\cup Q|\ge62$. We record that the obvious heuristic does not explain it: the integrality
$\Delta_d(R)\mid d'R+d^2$ has probability of order $1/\Delta_d(R)$, which is negligible at every
$\omega(e)$ and not only at the floor, so a proof would have to use something the floor has and the
rungs above it do not.
