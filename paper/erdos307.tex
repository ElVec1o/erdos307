...
\[ a=449\cdot9851\cdot152879\!\!\prod_{7\le p\le271}\!\!p \quad(58\text{ primes},\ 121\text{ digits}),
   \qquad a'=2\cdot3\cdot5\cdot P_{120}, \]
and, exactly,
\[ r(a)=1-5.377478\times10^{-10},\qquad \sigma(a)<\tfrac{30}{31},\qquad a''<a, \]
which is $1.5\times10^{7}$ times closer to $1$ than the previous record from below. For this witness
$30a-31a'$ is a $114$--digit number where a solution needs $900$, which is the honest measure of the
...
\texttt{code/nearmiss\_ladder\_verify.gp} and \texttt{code/nearmiss\_below\_verify.gp})}. Consistently with the two--sided statement above, $a$
