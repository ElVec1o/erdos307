...
with $37$ survivors at $|T|=7$, none at $|T|=8$, and again no two--cycle. The range
$9\le|T|\le34$ is not decided, since $\alpha^{2}<D$ bounds $|T|$ by $34$, so the sieve reduces the
level--$60$ single--tail question without closing it.
