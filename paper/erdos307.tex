...
Open problems: (i) close the residual $3{,}444$ single--tail families at level $60$; the pair sector of
Proposition~\ref{prop:sectors} is empty (Proposition~\ref{prop:pairclosed}), so these families are all that stands
between the barrier and $|P\cup Q|\ge61$ (the canonical tail family
