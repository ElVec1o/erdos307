...
the first $68$ primes ($1{,}258{,}448$ sets; \texttt{hunt/close60.rs}) finds none passing even the
plus--square, so no level--$60$ solution has all its primes $\le337$; the enumeration extends with
compute.
\end{remark}
