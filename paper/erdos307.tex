...
\date{Version 1.51.0\quad 2 September 2026}
...
$e'=42q$ is even); hence $\omega(e)\ge66$, and $|P\cup Q|=|\{2,3,7,q\}|+\omega(e)\ge70$.
\end{proof}
...
buys. Among all sectors $d$ that are squarefree with $\omega(d)\le8$ and every prime factor at most
$47$, exactly $250$ have mass floor $|P\cup Q|=60$; in every one of them the floor value of
...
and any support of size $60$ must have $\omega(d)\ge9$ or a sector prime exceeding $47$. This does
...
over primes at most $59$ with $\omega(d)\le10$, and the full range carries the same $2^{58}$ split
ambiguity as the tail families themselves. Finiteness here converts the sector programme into a
