...
are smooth \emph{by construction} rather than filtered for smoothness after the fact, and we do not
have a construction that respects the mass window while doing so.
\end{remark}
