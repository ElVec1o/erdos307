...
Proposition~14.17 of the full version (which over $\mathbb{Z}$ carries the entire obstruction, via
...
$|U|\le68$ (Proposition~14.17 of the full version); and in the level, the forced core and the ceiling that
...
\texttt{split\_product} the two--layer form of Proposition~14.17 of the full version, and
...
Proposition~14.17 of the full version: the smaller member needs $T_k\ge1/t_n$, which gives $k\ge3$ for
...
part to $33$, and by level $68$ --- the top of the window Proposition~14.17 of the full version says a level
