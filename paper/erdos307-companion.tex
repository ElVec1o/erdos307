...
Section~\textup{\ref{K-sec:barrier}}; it grows without bound as $\sigma(a)$ leaves $1$ in either
direction.
\end{proposition}
\begin{proof}
The supports are disjoint (Theorem~\ref{K-thm:structure}), so
...
Corollary~\ref{K-cor:threethirteen} the integers with $\sigma(n)=1-1/n$ \emph{exactly} are the primary
