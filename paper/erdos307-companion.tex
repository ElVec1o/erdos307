...
$\sigma(a)=1/q+\sigma(d)$, and since $q$ is astronomically large (Proposition~\ref{K-prop:close59}),
...
Corollary~\ref{K-cor:threethirteen} those are the $u=1$ solutions of \#307's coprime relaxation: the
...
tail parametrisation of Proposition~\ref{K-prop:tailbound}: substituting $e=d+qd'$ and $e'=qd$ into
